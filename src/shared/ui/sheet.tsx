  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-card/95 shadow-none backdrop-blur-md transition ease-in-out duration-300 data-[state=closed]:animate-out data-[state=open]:animate-in",
          side === "right" &&
