...
### Test Coverage (34 files, 208 tests)
...
- competitions: competition, schedule, event, staff, judge, registration, entry, payment, number, tba, team-match, add-drop, round, schedule-estimation, stats, awards
