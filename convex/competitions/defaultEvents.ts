 ...
 * are individual single-dance events. When an organizer creates a
 * competition and selects styles, the system generates all events from this
 * config — they can then prune what they don't want.
 */
...
const STANDARD: StyleConfig = {
  ...
  levels: {
    ...
    champ: {
      grouped: ["Waltz", "Tango", "Foxtrot", "Quickstep", "Viennese Waltz"],
    },
  },
};
